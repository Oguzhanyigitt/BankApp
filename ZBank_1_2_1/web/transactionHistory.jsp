    ...
    <div class="container">
        ...
        <div class="table-container">
            <div class="row header">
                ...
                <div class="cell">Gönderilen Miktar ve Türü</div>
                <div class="cell">Gönderilen TL Miktarı</div>                
            ...
            <div class="row">
                ...
                <div class="cell"><%= transaction.getOriginalAmount() %> <%= transaction.getCurrency() %></div>
                <div class="cell"><%= transaction.getAmount() %> TRY</div>
                <div class="cell"><%= transaction.getBalanceAfterTransaction() %> TRY</div>
            ...
            %>
            <div class="row">
                <div class="cell" colspan="10">İşlem Bulunamadı.</div>
            </div>
            <% } %>
        </div>
