...
public class TransferServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (Connection conn = DatabaseUtil.getConnection()) {
            ...
            logTransactions(conn, loggedInAccountId, values.toAccountId, values.amount, values.currency);
    ...
    private void logTransactions(Connection conn, Integer loggedInAccountId, int toAccountId, BigDecimal amount, String currency) throws SQLException {
        ...
        logTransaction(conn, "Giden", amount, currency, loggedInAccountId, senderBalance, loggedInAccountId, senderName, senderLastName, String.valueOf(toAccountId), recipientName, recipientLastName, now);
        logTransaction(conn, "Gelen", amount, currency, toAccountId, recipientBalance, loggedInAccountId, senderName, senderLastName, String.valueOf(toAccountId), recipientName, recipientLastName, now);
    }
