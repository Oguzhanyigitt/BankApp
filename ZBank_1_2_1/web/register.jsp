...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; background-color: #f2f2f2; background-image: url('Background linkini buraya girin'); background-size: cover; background-repeat: no-repeat; background-position: center; margin: 0; padding: 170px; }
